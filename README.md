...
You now need to get an URL for the album you want. Head back to https://mandibull.github.io/slideshow/index.html and accept the prompts you've already seen during the initial setup.

After that you should see your albums listed:
